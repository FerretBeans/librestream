...
use log::{info, error};
use multitag::{data::{self, Album, Picture, Timestamp}, Tag};
use serde::Deserialize;

pub fn metadata(file: &Path, songtitle: Option<String>, songartist: Option<String>, date: Option<Timestamp>, lyrics: Option<String>, /*cover: Option<String>*/) {
